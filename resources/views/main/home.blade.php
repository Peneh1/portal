                ...
                <div class="col-md-4">
                    <div class="footer-col middle">
                        ...
                        <ul class="list-unstyled li-space-lg p-small">
                            ...
                            <li class="media">
                                <i class="fas fa-square"></i>
                                <div class="media-body">Read our <a class="white" href="terms-conditions">Terms & Conditions</a>, <a class="white" href="privacy-policy">Privacy Policy</a></div>
                            </li>
                        </ul>
                    </div>
                </div> <!-- end of col -->
                    ...
                    <div class="footer-col last">
                        ...
                        <ul class="list-unstyled li-space-lg p-small">
                            <li class="media">
                                ...
                                <div class="media-body">22 Innovative, New York, NY 11206, US</div>
                            </li>
                            <li class="media">
                                <i class="fas fa-envelope"></i>
                                <div class="media-body"><a class="white" href="mailto:support@portalpix.com">support@portalpix.com</a> <i class="fas fa-globe"></i><a class="white" href="#your-link">www.portalpix.com</a></div>
                            </li>
                        </ul>
                    </div> 
                </div> <!-- end of col -->
